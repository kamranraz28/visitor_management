...
<div class="col-md-7 col-lg-12 col-xl-12" style="padding-top: 200px; padding-bottom: 50px; background-color: skyblue;">
    ...
    <div class="mx-auto" style="max-width: 500px;">
        ...
        <form action="{{route('applyStore')}}" method="post">
            ...
            <div class="mb-3">
                <label for="staff" class="form-label">Whome to visit</label>
